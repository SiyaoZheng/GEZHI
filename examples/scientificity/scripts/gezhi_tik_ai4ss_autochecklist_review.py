#!/usr/bin/env python3
"""GEZHI oracle tik wrapper for the AI4SS AutoChecklist reviewer."""
...
def main() -> int:
    ...
    artifact = env_path("GEZHI_ARTIFACT", ROOT / "output" / "scientificity-paper.pdf")
    run_dir = env_path("GEZHI_RUN_DIR", ROOT / ".gezhi" / "manual-ai4ss-autochecklist")
    ...
    if process.returncode != 0:
        ...
        print("")
        print("AutoChecklist runner failed before producing a valid gezhi verdict.")
        print("")
