...
GEZHI implements the parts of this protocol
...
The mechanisms that matter most for GEZHI are:
...
notifications for unresolvable external dependencies. For GEZHI, those
...
For GEZHI, this is a useful ancestor but not the whole design. Goal mode
...
## GEZHI Design Consequence

A GEZHI goal must be centered on one finished thing. The thing can
